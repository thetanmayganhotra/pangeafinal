export const createNFTAddressP = "0xFbC34671E544D7d1088c3172ee9F3B1f33372fb0";

export const createNFTAbiP = [
  {
    inputs: [
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint256", name: "tracker", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }],
    name: "minterOfToken",
    outputs: [{ internalType: "address", name: "_minter", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
